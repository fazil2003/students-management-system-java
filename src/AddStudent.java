...
public class AddStudent{
    ...
    public void show(){
        ...
        JLabel labelTitle = new JLabel("Add New Student");
        ...
        // BUTTON SUBMIT
        JButton buttonSubmit = new JButton("Add Student");
        ...
        buttonSubmit.addActionListener(
            new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                   ...
                   dbFunctions.addData(rollno, name, DOB, GPA, hosteler);

                   JOptionPane.showMessageDialog(addFrame, "Data inserted successfully.");  
                }
             }
        );
